...
class PlacesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @place.save
          format.html { redirect_to @place, notice: "Place was created." }
    ...
    def update
      respond_to do |format|
        if @place.update(place_params)
          format.html { redirect_to @place, notice: "Place was updated." }
    ...
    def destroy
      @place.destroy
      respond_to do |format|
        format.html { redirect_to places_url, notice: "Place was destroyed." }
